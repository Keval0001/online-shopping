...
public class ProductTestCase {
	...
	public static void init(){
		...
		context.refresh();
		productDAO = (ProductDAO) context.getBean("productDAO"); // Use of @Repository
	}
...
/*	@Test
	...
	public void testListActiveProductsByCategory(){
		assertEquals("Something went wrong while fetching the list of product!", 3 , productDAO.listActiveProductByCategory(3).size());
		assertEquals("Something went wrong while fetching the list of product!", 2 , productDAO.listActiveProductByCategory(1).size());
	}
